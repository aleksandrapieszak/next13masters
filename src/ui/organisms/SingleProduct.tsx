...
export const SingleProduct = async ({ product }: SingleProductItemProps) => {
    ...
    return (
        <div className="bg-white">
            {/*<div className="pb-8 pt-6 sm:pb-14">*/}
                <div className="mx-auto mt-8 max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                    <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">

                        {/* Obrazek produktu - na mniejszych ekranach na górze */}
                        <div className="lg:order-2 mt-8 lg:col-span-7 lg:col-start-1 lg:row-start-1 lg:mt-0">
                            <div className="grid grid-cols-1 lg:grid-cols-1 lg:gap-8">
                                <div className="max-h-96 sm:col-span-1 sm:mb-24">
                                    {product.images[0] && (
                        ...
                        {/* Opis produktu */}
                        <div className="lg:order-1 lg:col-span-5 lg:col-start-8">
